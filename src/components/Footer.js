  ...
  return (
    <footer className="footer">
          ...
          <div className="footer__socialmedia">
            ...
            <a href="https://linkedin.com/sorayavalle" title="This is my Linkedin!" target="_blank" rel="noopener noreferrer"> <FontAwesomeIcon icon={faLinkedin} className="icon__social" /></a>
